...
client_id = "303238530248-g2sshp334fkmq3htovp6a0sps9p4tgmd.apps.googleusercontent.com"
client_secret = "mfyXhE4v_0lEConh4FcAJUjW"
# redirect = "http://127.0.0.1:8000/"
scope = 'https://www.googleapis.com/auth/drive'
redirect_drive = "http://127.0.0.1:8000/drive-callback"
...
def box_auth(request):
    ...
    auth_url, csrf_token = oauth.get_authorization_url('http://127.0.0.1:8000/box-callback')
...
def get_dropbox_auth_flow(web_app_session):
    redirect_uri = "http://127.0.0.1:8000/dropbox-auth-finish"
